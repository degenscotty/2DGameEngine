...
void SceneSelectorScene::Initialize()
{
	m_pMainMenuBackGround = ResourceManager::GetInstance()->LoadTexture("SelectorBackGround.png");
...
void SceneSelectorScene::Update()
{
...
void SceneSelectorScene::Render()
{
